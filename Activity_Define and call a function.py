...
# the alert function prints out "Potential security issue. Investigate further". 
...
# allows you to be more efficient when needing to reuse the code. Instead of printing out that statement, you can juse use the alert function to do that.
...
# It shows "Potential security issue. Investiage further. three times.
...
# output shows each element from username_list on a new line.
...
# It shows all the names from the username_list, but it is all merged together in one line and hard to read.
