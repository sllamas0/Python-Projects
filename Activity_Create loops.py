...
# The messages in both loops where the same. In the for loop, i was defined and stoped after the conditions set. In a while loop, connection_attempts had to be updated.
...
for i in ip_addresses:
	if i in allow_list:
		...
		print("IP address is not allowed. Further investigaion of login activity required.")
		break 
