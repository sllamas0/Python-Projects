...
# It shows the data type to be a string.
...
# The data type appears to be a class list.
...
# The data type of max_logins is a class integer.
...
# the output above shows data type of logins_attempts is an integer, so it stores an integer value.
...
# It is true, so login_attempts is less than or = to max logins.
...
# It is false, so the login_attempts is not less than or equal to max_logins, so it is more than max logins
