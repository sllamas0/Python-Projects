...
# the first print, prints the name of the text file. The second print shows the IP addresses from the remove_list.
...
# There are 4 IP addresses also on the remove list.
...
# The benefits is that it will help organize the code and allow it to be reused.
