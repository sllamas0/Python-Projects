...
# I observed that the code ran Hello World!
...
# There was no output, as there are only comments written.
...
# I observed that it displayed the text "I am using python"
...
# I saw that the script printed out "I am a security analyst"
...
# This cell displayes "Python is useful for security"
...
# I observed that the script printed out "Python is useful for security"
