...
# The first time data type displayed as a integer, the second time though after its reassingment its is a string.
...
# the code outputs domain name .com by first saving the position in ind variable, then taking out the 4 consecutive characters from url starting from saved pos.
# 
# 
