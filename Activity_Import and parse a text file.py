...
# Before using the .split() it was just one long sentance, afture using taht method the output is shorter.
...
# it is on the bottom of the log file, so the log file is from oldest to most recent.
